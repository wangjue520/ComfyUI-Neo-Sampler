...
from .nodes_extra import NODE_CLASS_MAPPINGS as _EXTRA, NODE_DISPLAY_NAME_MAPPINGS as _EXTRA_NAMES  # noqa: E402

NODE_CLASS_MAPPINGS = {**NODE_CLASS_MAPPINGS, **_EXTRA}
NODE_DISPLAY_NAME_MAPPINGS = {**NODE_DISPLAY_NAME_MAPPINGS, **_EXTRA_NAMES}
